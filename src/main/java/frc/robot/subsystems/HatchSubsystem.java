...
public class HatchSubsystem extends BaseSubsystem {
  ...
  public HatchSubsystem() {
    ...
    solenoid2 = new DoubleSolenoid(RobotMap.CAN.PCM_ID, RobotMap.PNEUMATICS.HATCH_RELEASE_TOP);
    solenoid3 = new DoubleSolenoid(RobotMap.CAN.PCM_ID, RobotMap.PNEUMATICS.HATCH_RELEASE_BOTTOM);
